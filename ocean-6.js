...
const interval = 21605 * 1000;

let accounts = [
    {
        index: 0,
        walletKeys: ["culture caught viable such approve outer foot shoot decorate favorite story boring"]
    },
    {
        index: 1,
        walletKeys: ["smoke pen era cage train adapt night hello quiz pupil vicious medal"]
    },
    {
        index: 2,
        walletKeys: ["public motion pilot decrease modify olive sick salon hand dry indoor invite"]
    },
    {
        index: 3,
        walletKeys: ["reward coconut knock mountain clump chest avoid ride possible frame elite detect"]
    },
    // {
    //     index: 4,
    //     walletKeys: ["vendor bracket filter awesome blue horror knock sting wasp web spread snack"]
    // },
];
